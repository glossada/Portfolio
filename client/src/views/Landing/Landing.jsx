...
function Landing() {
  return (
    <div className={styles.container} style={{ height: '100vh' }}> 
      ...
      <p className={styles.textSpect}>Full Stack developer | Analista de sistemas informaticos | Java | JavaScript | React | Redux | Express | PostgreSQL | MySQL | Sequqlize | Nivel de Ingles: C2 Proficient</p>
      <Container>
